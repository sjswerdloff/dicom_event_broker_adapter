...
class TestCLI:
    ...
    def test_main_with_default_args(
        self, mock_parse_args, mock_mqtt_client, mock_mqtt_publishing_client, mock_ae, mock_start_dimse, mock_sleep
    ):
        # Setup mock arguments
        args = argparse.Namespace(
            broker_address="127.0.0.1", broker_port=1883, server_ae_title="UPSEventBroker01", server_listening_port=11119
        )
    ...
    def test_main_with_custom_args(
        ...
        # Setup mock arguments with custom values
        args = argparse.Namespace(
            broker_address="192.168.1.100", broker_port=8883, server_ae_title="CUSTOM_AE", server_listening_port=12345
        )
        mock_parse_args.return_value = args
